...
{
    public class FamilyValidatorBase<T> : AbstractValidator<T> where T : FamilyRequestBase
    {
        ...
        public FamilyValidatorBase(ICountyService<Domain.Models.County> countyService, IStateService<Domain.Models.State> stateService)   
        {
